<div class="row navbar d-flex justify-content-center">
    <div class="container container-navbar d-flex align-items-center justify-content-center">
        <div class="row">
            <div class="col-1 d-flex align-items-center">
              <a href="/" class="link-logo"><h3 class="logo">ONEVE</h3></a>
            </div>
            <div class="col-2 d-flex align-items-center justify-content-center">
              <a href="{{ route('home.search') }}" class="btn cari-event">Cari Event</a>
            </div>
            <div class="col-6 col-search d-flex align-items-center">
              <div class="row">
                <form action="{{ route('home.search') }}" method="GET" class="form">
                  <div class="form-navbar-search d-flex align-items-center">
                      <input type="text" name="search" placeholder="Search" class="form-search">
                      <button class="tombol-icon-search">
            ...
            <div class="col-3 d-flex align-items-center justify-content-end">
                <a href="{{ route('create.event') }}" class="btn btn-buat">Buat Event</a>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-right dropdown-account" aria-labelledby="dropdownMenuButton">
                      <div class="d-flex dd-account align-items-center justify-content-start">
                          <div>
                            <img src="{{ Auth::user()->avatar }}" width="48px" height="48px"/>
                          </div>
                          ...
                          <form id="formRegister" method="POST" action="{{ route('register') }}">   
                            @csrf
                              <div class="form-control form-control-akun">
                                  <input id="registerNama" type="text" placeholder="Nama" name="name" class="form-nama">
                              ...
                              <div class="form-control form-control-akun">
                                  <input id="registerEmail" type="email" placeholder="Email" name="email" class="form-email">
                                  <span class="material-icons-outlined icon-error">
                                    error_outline
                                    </span>
                                    <small>Error</small>
                              ...
                              <div class="form-control form-control-akun">
                                  <input id="registerPassword" type="password" placeholder="Password" name="password" class="form-password">
                                  <span class="material-icons-outlined icon-error">
                                    error_outline
                                    </span>
                                    <small>Error</small>
                              ...
                              <div class="form-control form-control-akun">
                                  <input id="registerPassword2" type="password" placeholder="Ulang Password" name="password_confirmation" class="form-password">
                                  <span class="material-icons-outlined icon-error">
                                    error_outline
                                    </span>
                                    <small>Error</small>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body form">
                          <form id="formLogin" method="POST" action="{{ route('login') }}">   
                            @csrf
                            <div class="form-control form-control-akun">
                              <input id="loginEmail" type="email" placeholder="Email" name="email" class="form-email">
                              <span class="material-icons-outlined icon-error">
                                error_outline
                                </span>
                                <small>Error</small>
                            ...
                            <div class="form-control form-control-akun">
                                <input id="loginPassword" type="password" placeholder="Password" name="password" class="form-password">
                                <span class="material-icons-outlined icon-error">
                                  error_outline
                                  </span>
                                  <small>Error</small>
